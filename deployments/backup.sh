...
# Configuration
PROFILE="shared-piksel"
REGION="ap-southeast-3"
BUCKET_NAME="terraform-backup-shared-piksel-taufik" # bucket name should be unique globally
RESTORE_DIR="tf_backup"

# Files to backup/restore (add or remove as needed)
FILES=(
    "terraform.tfstate"
